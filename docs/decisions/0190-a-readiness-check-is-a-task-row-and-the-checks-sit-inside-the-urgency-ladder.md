...
**Amended 2026-09-25 by [ADR-0239](0239-a-finished-trip-is-a-memory-not-a-plan.md) §3:** on a finished trip the checks retire. A manual task that fell due before the trip ended reads as never done, in neutral rather than `--miss`, and one due after the end keeps its place in the ladder. **Built 2026-09-25** (PR #870).
