...
## AJ. An infeasible leg is still a JOURNEY — the warn glyph keeps its mode (2026-08-26)
...
### AJ1. Why the swap is wrong, and it is not a matter of taste
...
### AJ2. Compose the mark; do not mint the matrix
...
### AJ3. What the mockup has to settle, because none of it is decidable from here
