...
| [0045](0045-trip-home-real-data-only.md)                      | Trip-mode Home shows real data only: quick-access reworked to four real shortcuts (next code / WiFi / documents / navigate-to-next), the weather/FX/budget glance row replaced by a derived day-at-a-glance card (refines 0004/0006/0014) | Accepted |
