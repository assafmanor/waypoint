...
| [0044](0044-settling-a-finished-trip.md)                      | Should Done/Skip/Restore settling extend to a finished trip? (proposes a read-only _structural_ archive that stays settle-editable; refines 0040/0043)                                                                            | Proposed |
