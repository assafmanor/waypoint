...
>
> - **The drag keeps the centre** for the reason §3 gave and the device did not contradict: the finger is _resting on the anchor for the entire gesture_, so a point-anchored drag converges on the one spot you cannot see.
