...
- **What remains for a phone:** whether the recalibrated 120px reads right at both stops, `TAP_GAP_MS` now that it is 500, and **whether the double-tap should anchor at the tapped point** rather than the centre — §3 left point-anchoring additive, and taking Google's double-tap over is what made it a live question, since Google _did_ anchor there. That one joins Phase 3's existing line rather than opening a new one.
