...
- **`clickableIcons: false`**, to stop Google answering POI taps at all. Rejected in ADR-0147 and still rejected: it suppresses the _tap_, not a card, so the label stops being tappable — and Google's own card is now the thing we want.
