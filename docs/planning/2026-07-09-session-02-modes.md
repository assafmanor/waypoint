...
Keep the design open to **web/AI enrichment** — auto-pulling hours/photos/details or filling booking fields. Treated as a future *pipe* (ADR-0004): enrich existing entities, never a new screen. Requirements to stay compatible: preserve `source`/provenance and keep `placeId`/free-text separable. Captured in modes.md + integrations/overview.md + feature-catalog (vNext).
