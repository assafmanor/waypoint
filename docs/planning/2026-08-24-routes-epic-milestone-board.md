...
**[ADR-0206 §AJ](../decisions/0206-a-travel-time-belongs-between-two-points.md)**; read it rather
than this summary.

**It reverses something M6a shipped**, deliberately and with a stated reason
(`DayJoinRow.tsx:244` — `icon={overrunning ? 'warn' : travelMode}`). §AJ1 is why the reason does not
...
doubles. §AJ2: one mode glyph plus a **composited** warning mark is 4 assets, and the repo already
