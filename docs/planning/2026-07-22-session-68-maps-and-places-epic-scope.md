...
| 1   | **Design — the Map surface**   | The list-first tab, filter chips (reuse the Index grammar), mode defaults, pin/marker visual, geolocation-permission UX, and the Phase-6 brand-styled map look.   | ADR-0106 (+ its embedded-map §); `design/design-language.md`; `design/mockups.md`                 | — (needs no code)        | A Map mockup + a design ADR                               |
