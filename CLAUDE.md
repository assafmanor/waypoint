...
- `mockups/trip-home-v3.html` — the redesigned **Trip-mode Home** (ADR-0045): board hero unchanged, quick-access reworked to four real shortcuts (next code / WiFi / documents / navigate-to-next), and the fixture weather/FX/budget glance row replaced by a derived "day at a glance" card. Real-data-only home.
