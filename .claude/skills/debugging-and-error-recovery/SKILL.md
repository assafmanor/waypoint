...
For test failures (npm shown — substitute the repository's own test command, per the agent-skills-test-driven-development skill's Discover the Stack First section):
```bash
