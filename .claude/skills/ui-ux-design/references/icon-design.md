...
python3 ${CLAUDE_SKILL_DIR}/scripts/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```
...
```bash
python3 ${CLAUDE_SKILL_DIR}/scripts/icon/generate.py --list-styles
python3 ${CLAUDE_SKILL_DIR}/scripts/icon/generate.py --list-categories
```
