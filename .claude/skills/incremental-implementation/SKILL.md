...
4. **Commit** -- save your progress with a descriptive message (see `docs/engineering/conventions.md` for atomic commit guidance)
...
After each increment, verify with the repository's own commands (see the agent-skills-test-driven-development skill's Discover the Stack First section):
