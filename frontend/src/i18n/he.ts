...
export const t = {
  ...
  shell: {
    ...
    zeroState: {
      ...
      joinToast: 'קיבלת קישור מחבר? פשוט פתח אותו — ותוך שנייה אתה בפנים',
      offline: 'יצירת טיול צריכה חיבור · קישור שחבר שולח ייפתח גם עכשיו',
      teach: 'בחבורה של חמישה, בדרך כלל אחד יוצר את הטיול — וכל השאר נכנסים עם הקישור שלו.',
    },
    stub: {
      newTrip: 'טיול חדש',
      join: 'הצטרפות לטיול',
