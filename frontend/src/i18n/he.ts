...
export const t = {
  ...
  shell: {
    ...
    zeroState: {
      ...
      create: 'טיול חדש',
      createSub: 'אתם המארגנים',
      join: 'הצטרפות עם לינק',
      joinSub: 'קיבלתם לינק הזמנה',
      joinToast: 'פותחים את הלינק שקיבלתם מחבר/ה — ותוך שנייה אתם בפנים',
      offline: 'יצירת טיול צריכה חיבור · לינק שחבר/ה שולח/ת ייפתח גם עכשיו',
      teach:
        'בחבורה של חמישה בדרך כלל אחד/ת פותח/ת טיול, וכל השאר מצטרפים עם הלינק שהוא/היא שולח/ת.',
    },
    stub: {
      newTrip: 'טיול חדש',
      join: 'הצטרפות לטיול',
