...
// value is a numeric/short run, so it's dir=auto + mono (design-language
...
export interface StatTileProps {
  /** The stat value — a number or short run (rendered mono, dir=auto). */
  value: ReactNode;
  label: ReactNode;
}
...
export function StatTile({ value, label }: StatTileProps) {
  return (
    <div className="wp-stattile">
      <div className="wp-stattile-v" dir="auto">
        {value}
      </div>
